...
exports.TransactionType = prisma_1.TransactionType;
...
exports.TransactionSchema = zod_1.z.object({
    ...
    action: zod_1.z.nativeEnum(exports.TransactionType),
...
exports.AnalyticsQuerySchema = exports.DateRangeSchema.extend({
    cropIds: zod_1.z.string().optional().transform((val) => val ? val.split(',') : undefined),
    transactionType: zod_1.z.nativeEnum(exports.TransactionType).optional(),
});
