...
// Import routes
var crops_1 = require("./routes/crops");
...
app.listen(port, function () {
    console.log("\uD83D\uDE80 Business Inventory Backend running on port ".concat(port));
    console.log("\uD83D\uDCCA Health check: http://localhost:".concat(port, "/health"));
    console.log("\uD83C\uDF10 Frontend URL: ".concat(process.env.FRONTEND_URL || 'http://localhost:3002'));
});
exports.default = app;
